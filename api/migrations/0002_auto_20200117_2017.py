    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_datetime', models.DateTimeField(blank=True, default=datetime.datetime(2020, 1, 17, 20, 17, 2, 457209))),
        ...
        migrations.AddField(
            ...
            name='a_datetime',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2020, 1, 17, 20, 17, 2, 455506)),
        ),
        migrations.AddField(
            model_name='events',
            name='e_code',
        ...
        migrations.AlterField(
            model_name='news',
            name='n_datetime',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2020, 1, 17, 20, 17, 2, 456228)),
        ),
        migrations.AlterField(
            model_name='news',
            name='n_image',
