...
urlpatterns = [
  ...
  # just token - url(r'^login/$', LoginUserDetailView.as_view(), name='rest_login'),
  
 #REDUNDANT url(r'^custom/register/$', VeryNewCustomRegisterView.as_view(), name='rest_register'),
